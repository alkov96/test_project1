...
public class Constants {
    ...
    public static final String СITIZENSHIP = "Гражданство";
    ...
    public static final String BUILDING = "Строение";
    public static final String BLOCK = "Корпус";
    ...
    public static final String SNILS = "СНИЛС";
