...
Функционал: API
  ...
  Сценарий: Проверка confirmAndUpdateNewPhone при невалидном authToken
    * сохраняем в память
  ...
  Сценарий: Проверка confirmAndUpdateNewPhone при невалидном updateToken
    * сохраняем в память
  ...
  Сценарий: Проверка confirmAndUpdateNewPhone при неправильном коде
