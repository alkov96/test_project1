# language: ru
  Функционал: 3_Ставки
    ...
    @DayEventsCoupon
      ...
      * пользователь (проверяет, совпадают ли события в купоне с ожидаемыми из) "TEAM_1" "TEAM_2"

      #* пользователь (проверяет, совпадает ли исход в купоне с ожидаемым) "OUTCOME"
      * пользователь (сравнивает коэфиценты) "OUTCOME"
